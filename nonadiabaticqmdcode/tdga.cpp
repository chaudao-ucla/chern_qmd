...
void TB_model::init_from_file(void)
{
...
void TB_model::integrate_EOM_RK4_v2(double dt) {
...
void TB_model::simulate_noneq(int max_steps, double dt, double U_i, double U_f) {
